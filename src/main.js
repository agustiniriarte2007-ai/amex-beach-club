...
function bg(url,fallbackUrl){const u=url||fallbackUrl;return `background-image:url(${JSON.stringify(u)});background-position:center;background-size:cover;background-repeat:no-repeat`}
